...
def transactions() -> list[dict]:
    """Данные для теста функций filter_by_currency и transaction_descriptions в generators.py"""
...
@pytest.fixture
def trans_descriptions() -> list[str]:
    """Описания транзакций для теста функции transaction_descriptions в generators.py"""
