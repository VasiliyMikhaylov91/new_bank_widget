...
def test_process_bank_search(operation: list[dict], search_word: str, result: list[dict]) -> None:
    """Тестирование функции process_bank_search"""

    assert process_bank_search(operation, search_word) == result
