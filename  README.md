...
6. Для работы с модулем utils необходимо получить ключ API с https://apilayer.com/marketplace/exchangerates_data-api и создать файл .env в соответствии с .env.example
## Описание функций
...
```
В модуле utils:
- Функция data_from_json принимает на вход путь до JSON-файла и возвращает список словарей с данными о финансовых транзакциях. Если файл пустой, содержит не список или не найден, функция возвращает пустой список.
- Функция transaction_amount_rub принимает на вход транзакцию и возвращает сумму транзакции в рублях, тип данных — float. Если транзакция была в USD или EUR, происходит обращение к внешнему API для получения текущего курса валют и конвертации суммы операции в рубли.
В модуле file_convertations:
- Функция read_csv_transactions принимает на вход путь до csv-файла и возвращает список словарей с данными о финансовых транзакциях.
- Функция read_xlsx_transactions принимает на вход путь до xlsx-файла и возвращает список словарей с данными о финансовых транзакциях.
